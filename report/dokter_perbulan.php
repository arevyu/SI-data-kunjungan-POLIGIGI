...
<html>
    <head>
        <title>Cetak Data Dokter Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA DOKTER <? echo "$bulanNama $ambilthn"; ?></h3>
                        <table class="table table-bordered table-striped table-hover">
                        <tbody>
                <thead>
								<tr>
									<th>No.</th><th>NIP Dokter</th><th>Nama Dokter</th><th>Tanggal </th><th>No Hp</th><th>Jam</th><th>Keterangan</th>
								</tr>
								</thead>
							<tbody>
                            ...
                            $sql = "SELECT * FROM dokter WHERE substr(tgl,1,7)='$ambilthn-$ambilbln'";
