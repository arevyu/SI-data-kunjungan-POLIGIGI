    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-danger">
                <strong>Selamat Datang di SI Data Pelanggan Poli Gigi Kisaran</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Data Pelanggan Poli Gigi</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">No. Pengunjung</th><th>Nama</th><th>Tanggal</th><th>Keterangan</th>
                            </tr>
                        </thead>
                        <tbody>
